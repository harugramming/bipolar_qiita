...
@section('title', 'プライバシーポリシー - bipolarTips - 双極性障害向け知識共有サービス')
...
<div class="wrapKOPIPE">
    ...
    <h1>プライバシーポリシー</h1>
    <p>bipolarTips（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
