...
@section('title', '利用規約 - bipolarTips - 双極性障害向け知識共有サービス')
...
<div class="welcome">
  ...
  <div class="wrapHINAGATA">
    ...
    <p>この利用規約（以下，「本規約」といいます。）は，bipolarTips（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
